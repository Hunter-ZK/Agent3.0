    ...
    def _validate_column_source(
        ...
        *,
        ...
        if (
            ...
            return self._validate_physical_column(
                table_name=source.physical_name,
                column_name=column_name,
                table_cache=table_cache,
            )

        if source.source_scope_id:
            ...
            if (
                column_name
                not in source_scope.output_columns
            ):
                return [
                    self._logical_column_not_found_issue(
