...
def build_sql_pilot_engine(
    *,
    ...
    # Explain 的确定性 Program/Evidence 层不依赖 LLM；
    # llm_client 仅控制是否可以做业务语义增强。
...
def build_trusted_sql_workflow(
    ...
    *,
    ...
    return TrustedSQLWorkflow(
        ...
        default_enable_llm=enable_llm,
        default_llm_provider=llm_provider_name,
        default_fix_provider=(
            "llm" if enable_llm else "auto"
        ),
    )
