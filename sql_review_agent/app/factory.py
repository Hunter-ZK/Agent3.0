...
def build_explain_agent():
    provider = os.getenv("SQLPLOT_EXPLAIN_PROVIDER","mock").lower()
...
def build_sql_review_engine(enable_llm: bool = False, llm_provider: str = "mock") -> SQLReviewEngine:
    ...
    return SQLReviewEngine(review_service=service, metadata_provider_factory=MockMetadataProvider, engine_agent=build_explain_agent())
